...
| 04 | [Megaline — Tariff Recommendation (Machine Learning)](04_megaline_tariff_recommendation_ml/) | Machine learning classification project predicting whether a user should choose the Smart or Ultra plan. Includes model comparison (LogReg, Decision Tree, Random Forest) and final evaluation. |
